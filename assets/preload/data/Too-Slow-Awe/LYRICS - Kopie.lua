...
local wordstuff = { -- The main meat of it all. Add text stuff here.
    {
	    startStep = 1150, -- The step of which the words appear, you can check where the steps are in the chart editor.
	    endStep = 1168, -- The step of which the words vanish.
	    speaker = "Sonic.EXE", -- The person speaking.
	    speakerColor = "FF0004", -- The hex color code for the speaker text.
	    text = "So little time.." -- The actual text itself.
    },
	{
		startStep = 1183, -- The step of which the words appear, you can check where the steps are in the chart editor.
		endStep = 1198, -- The step of which the words vanish.
		speaker = "Sonic.EXE", -- The person speaking.
		speakerColor = "FF0004", -- The hex color code for the speaker text.
		text = "Wouldn't you agree?" -- The actual text itself.
	},
	{
		startStep = 1200, -- The step of which the words appear, you can check where the steps are in the chart editor.
		endStep = 1205, -- The step of which the words vanish.
		speaker = "Boyfriend", -- The person speaking.
		speakerColor = "31B0D1", -- The hex color code for the speaker text.
		text = "Yeah!" -- The actual text itself.
	},
	{
		startStep = 1206, -- The step of which the words appear, you can check where the steps are in the chart editor.
		endStep = 1232, -- The step of which the words vanish.
		speaker = "Sonic.EXE", -- The person speaking.
		speakerColor = "FF0004", -- The hex color code for the speaker text.
		text = "*Maniacal Laughter*" -- The actual text itself.
	}
}
