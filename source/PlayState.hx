...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		songNameText.setFormat(Paths.font("Sonic Advanced 2.ttf"), 108, FlxColor.WHITE, "center");
		...
		composerText.setFormat(Paths.font("Sonic Advanced 2.ttf"), 38, FlxColor.WHITE, "center");
