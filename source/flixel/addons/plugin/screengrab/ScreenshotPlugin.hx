...
{
  public static final SCREENSHOT_FOLDER = 'screenshots-SDPJ';
  ...
  {
    CoolUtil.openFolder(SCREENSHOT_FOLDER);
  }
  ...
  {
    return '$SCREENSHOT_FOLDER/SkyDecayProject-screenshot-${Date.now().toString()}.png';
  }
