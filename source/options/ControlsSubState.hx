...
class ControlsSubState extends MusicBeatSubstate
{
	...
	override function update(elapsed:Float)
	{
		...
		if(!binding)
		{
			...
			// Is this like, too hard to do? Like bru - Joseph
			...
			// I hate the fact that you're forced to use the arrow keys. Like hellooo i don't have any arrows on my keyboard - Joseph
