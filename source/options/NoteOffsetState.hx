...
class NoteOffsetState extends MusicBeatState
{
	...
	override public function create() {
		...
		rating = new FlxSprite().loadGraphic(Paths.image('setUI/perfect')); //setUI
		...
		{
			var numScore:FlxSprite = new FlxSprite(43 * daLoop).loadGraphic(Paths.image('setUI/num' + i)); //setUI
	...
	override public function update(elapsed:Float)
	{
		...
		if(controls.BACK)
		{
			...
			else OptionsState.playOptionsMenuMusic();
